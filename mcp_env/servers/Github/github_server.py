...
with open(os.path.join(os.path.dirname(__file__), "fixtures", "github_PRs.json")) as f:
    PR_DATA = json.load(f)

REPO_BASE = os.path.abspath(os.path.join(os.path.dirname(__file__), "fixtures", "repos"))  # base path where repos are stored
DIFF_BASE = os.path.abspath(os.path.join(os.path.dirname(__file__), "fixtures", "diffs"))  # base path for diff files
